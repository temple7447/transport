              ...
              <div key={item.year} className="flex gap-6 mb-8">
                ...
                <div className="pb-8">
                  <div className="flex items-center gap-3 mb-1">
                    <span className="font-bold text-sm" style={{ color: '#CC1500' }}>{item.year}</span>
            ...
            {TEAM.map(member => (
              <div key={member.name} className="card-hover bg-white border border-slate-100 rounded-2xl overflow-hidden shadow-sm">
                ...
                <div className="p-6">
                  ...
                  <p className="font-semibold text-sm mb-2" style={{ color: '#CC1500' }}>{member.role}</p>
