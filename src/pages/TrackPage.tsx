...
const SHIPMENTS: Record<string, {
  ...
  'QSD-2024-987654': {
    ...
    origin: { city: 'Dubai', country: 'UAE', flag: '🇦🇪', date: 'May 13, 2026', hub: 'Accessiblexpress Dubai Export Hub' },
    ...
    route: [
      { city: 'Dubai',     country: 'UAE',     flag: '🇦🇪', done: true,  active: false, date: 'May 13' },
      { city: 'Istanbul',  country: 'Turkey',  flag: '🇹🇷', done: true,  active: false, date: 'May 14' },
    ...
    events: [
      ...
      { time: '22:30', date: 'Yesterday, May 15', location: 'Istanbul Airport (IST)', country: 'Turkey', flag: '🇹🇷', desc: 'Customs cleared — all documentation verified — flight departed to Frankfurt', type: 'customs', note: 'Duty-free, no further charges' },
      { time: '17:45', date: 'Yesterday, May 15', location: 'Istanbul Cargo Terminal', country: 'Turkey', flag: '🇹🇷', desc: 'Package submitted for transit customs inspection', type: 'customs' },
      { time: '14:10', date: 'Yesterday, May 15', location: 'Istanbul Hub', country: 'Turkey', flag: '🇹🇷', desc: 'Package received and logged into Accessiblexpress transit system', type: 'sort' },
      { time: '06:55', date: 'Yesterday, May 15', location: 'Dubai International Airport (DXB)', country: 'UAE', flag: '🇦🇪', desc: 'Package loaded onto cargo flight TK-6712 to Istanbul', type: 'flight' },
      { time: '11:00', date: 'May 13, 2026', location: 'Dubai Export Terminal', country: 'UAE', flag: '🇦🇪', desc: 'Shipment handed to airline cargo partner — all export documentation approved', type: 'customs' },
      { time: '08:30', date: 'May 13, 2026', location: 'Accessiblexpress Dubai Hub', country: 'UAE', flag: '🇦🇪', desc: 'Package picked up from sender — weighed, measured, and labelled', type: 'pickup', note: 'Package condition: Excellent' },
    ],
    alerts: [
  ...
  'QSD-2024-112233': {
    ...
    dest:   { city: 'Kumasi', country: 'Ghana', flag: '🇬🇭', hub: 'Kumasi Delivery Centre', recipient: 'Kofi A.', address: '14 Adum Street, Kumasi, Ashanti Region' },
    ...
    route: [
      ...
      { city: 'Koforidua', country: 'Ghana', flag: '🇬🇭', done: true, active: false, date: 'May 15' },
      { city: 'Kumasi', country: 'Ghana', flag: '🇬🇭', done: false, active: true,  date: 'May 16' },
    ],
    events: [
      { time: '08:03', date: 'Today, May 16', location: 'Kumasi — En Route to Recipient', country: 'Ghana', flag: '🇬🇭', desc: 'Driver Kwame S. is en route with your package — estimated arrival 4:30 PM', type: 'truck', note: 'Driver contact: +233 20 000 9876' },
      { time: '06:45', date: 'Today, May 16', location: 'Kumasi Delivery Centre', country: 'Ghana', flag: '🇬🇭', desc: 'Package sorted and assigned to delivery route #KSI-14', type: 'sort' },
      { time: '02:10', date: 'Today, May 16', location: 'Kumasi Inbound Hub', country: 'Ghana', flag: '🇬🇭', desc: 'Package arrived at Kumasi hub from overnight run', type: 'truck' },
      { time: '18:30', date: 'May 15, 2026', location: 'Koforidua Transit Hub', country: 'Ghana', flag: '🇬🇭', desc: 'Package transferred to Kumasi line truck — departed 6:30 PM', type: 'truck' },
      { time: '10:00', date: 'May 15, 2026', location: 'Koforidua Inbound Terminal', country: 'Ghana', flag: '🇬🇭', desc: 'Package arrived at Koforidua transit hub', type: 'sort' },
