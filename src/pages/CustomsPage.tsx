...
export default function CustomsPage() {
  return (
    <div className="pt-20">
      {/* Hero */}
      <div className="relative py-24 overflow-hidden" style={{ background: 'linear-gradient(135deg, #071426 0%, #050e1d 60%, #0e1e3c 100%)' }}>
            ...
            <div className="grid md:grid-cols-5 gap-6">
              {PROCESS.map((step, i) => (
                <div key={step.title} className="text-center">
                  <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 font-black text-xl relative z-10" style={{ background: i === 0 ? 'linear-gradient(135deg,#071426,#050e1d)' : i === PROCESS.length - 1 ? 'linear-gradient(135deg,#F5C100,#CC1500)' : 'white', color: i === 0 || i === PROCESS.length - 1 ? 'white' : '#64748b', border: '2px solid #e2e8f0' }}>
      ...
      {/* CTA */}
      <div className="py-16 text-center" style={{ background: 'linear-gradient(135deg, #071426, #050e1d)' }}>
        <div className="container mx-auto px-6">
